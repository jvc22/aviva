...
export default function LandingPage() {
  return (
    <div className="relative flex min-h-screen flex-col bg-zinc-950 text-zinc-100">
      <div className="pointer-events-none absolute -top-12 bottom-0 left-0 right-0 z-0 transform bg-landing-bg bg-no-repeat max-md:bg-top md:left-0 lg:bg-contain" />
      ...
      >
        <div className="flex flex-col items-center gap-8">
          <div className="space-y-3 text-center">
            <h1 className="bg-radial-gradient from-zinc-300 to-zinc-500 bg-clip-text text-5xl font-bold leading-none tracking-tight text-transparent md:text-6xl">
